...
[$statusText, $statusColor, $statusIcon] = $statusMap[$issue->status] ?? ['?', 'secondary', 'cil-info'];
...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
    ...
    <div class="d-flex gap-2 flex-wrap">
        ...
        {{-- [SỬA 1] Hủy: dùng @php pre-compute để tránh dấu " trong ternary bên trong onsubmit="..." --}}
        @if(!in_array($issue->status, [4, 5]))
        @php $cancelExtra = $issue->status === 3 ? '\nHàng đang giữ sẽ được giải phóng.' : ''; @endphp
