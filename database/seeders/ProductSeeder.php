...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $products = [
            ...
            ['code' => 'SP010', 'name' => 'Màn hình HMI Weintek MT8071iE 7 inch',          'category_id' => $catBoard, 'uom_id' => 1, 'uom_purchase_id' => null, 'barcode' => 'BC-SP010', 'alert_before_expiry' => 365,  'tracking_type' => 4, 'stock_rotation' => 2, 'status' => 1],
            ...
            ['code' => 'SP028', 'name' => 'Cáp mạng Cat6 chống nhiễu AMP (Cuộn 305m)',     'category_id' => $catCap,   'uom_id' => 2, 'uom_purchase_id' => null, 'barcode' => 'BC-SP028', 'alert_before_expiry' => 365,  'tracking_type' => 4, 'stock_rotation' => 2, 'status' => 1],
            ...
            ['code' => 'SP044', 'name' => 'Bộ nguồn lưu điện UPS APC 500VA',               'category_id' => $catBoard, 'uom_id' => 1, 'uom_purchase_id' => null, 'barcode' => 'BC-SP044', 'alert_before_expiry' => 365,  'tracking_type' => 4, 'stock_rotation' => 2, 'status' => 1],
